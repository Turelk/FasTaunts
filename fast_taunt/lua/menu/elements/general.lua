...
TitleMain = vgui.Create( "DLabel", menu1 )
...
DescMain = vgui.Create( "DLabel", menu1 )
...
DescMain2 = vgui.Create( "DLabel", menu1 )
...
local Workshop = vgui.Create( "DButton", menu1 )
Workshop:SetText( "Workshop Page" )
Workshop:SetPos( 10, 320 )
Workshop:SetSize( 100, 30 )
Workshop.DoClick = function()
    gui.OpenURL( "https://steamcommunity.com/id/turelk/" )
end

local Github = vgui.Create( "DButton", menu1 )
Github:SetText( "Github Page" )
Github:SetPos( 120, 320 )
Github:SetSize( 100, 30 )
Github.DoClick = function()
    gui.OpenURL( "https://github.com/Turelk/FasTaunter" )
end

local MyWorkshop = vgui.Create( "DButton", menu1 )
MyWorkshop:SetText( "My Workshop :)" )
MyWorkshop:SetPos( 230, 320 )
MyWorkshop:SetSize( 100, 30 )
MyWorkshop.DoClick = function()
    gui.OpenURL( "https://steamcommunity.com/id/turelk/myworkshopfiles/" )
end

MadeBy = vgui.Create( "DLabel", menu1 )
